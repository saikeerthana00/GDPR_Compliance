...
const BrowsingTransparentTab = ({ report }) => {
  ...
  const browsingData = report;
  const firstEntry = browsingData[0] || {};
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Here's how we break down each browsing entry
                </p>
              </div>
            </div>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="flex items-center space-x-2">
                                <a
                                  className=" text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50 truncate flex-1 transition-colors rounded px-1 py-0.5"
                                  title={firstEntry.Link}
                                  href={firstEntry.Link}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  {firstEntry.Link || "Unknown"}
                                </a>
                                <ExternalLink className="w-4 h-4 text-indigo-600 hover:scale-110 transition-transform flex-shrink-0" />
                              </div>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-3 flex-1">
                          ...
                          <p className="text-xs text-blue-600 mt-1">
                            The URL or link of the content you accessed
                          </p>
                        </div>
                      </motion.div>
                      ...
                      >
                        ...
                        <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-3 flex-1">
                          ...
                          <p className="text-xs text-green-600 mt-1">
                            Exact date and time when you visited this content
                          </p>
                        </div>
                      </motion.div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3 p-4 bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-lg border border-gray-100 hover:border-gray-200 transition-colors">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center space-x-2">
                            <a
                              className="font-medium text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50 truncate flex-1 transition-colors rounded px-1 py-0.5"
                              title={item.Link}
                              href={item.Link}
                              target="_blank"
                              rel="noopener noreferrer"
...
export default BrowsingTransparentTab;
